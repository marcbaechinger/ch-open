lesson("About Functions", function() {
  ...
  learn("about function scoping", function () {
  ...
  learn("how to use lexical scoping to synthesise functions", function () {
  ...
  learn("how to allow extra function arguments", function () {
