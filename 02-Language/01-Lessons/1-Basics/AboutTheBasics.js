...
lesson("About Operators", function() {
    ...
    learn("how to substract", function() {
        var result = 5;
        for (var i = 0; i <= 2; i++) {
            result = result - i;
        }
...
lesson ("About Variable Scope", function() {
    ...
    learn("that there is no lexical scope", function() {
        ...
        var result = "";
        out.forEach(function(func){ result += func(); });
    ...
    learn("how to use functions to provide private scope", function() {
        ...
        for(var i = 0; i<arr.length;i++) {
            (function(val) {
                var item = val; // this is a variable with "private" function scope
                out.push(function(){ return item; });
            })(arr[i]); // this is called an "Immediately Invoked Function Expression" (IIFE)
        }
